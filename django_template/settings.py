...
SECRET_KEY = 'django-insecure-ko5j0_716wnbp+&dy)96)vek2*)!29$lf6*m3%ca!k0339l4e*'
...
DATABASES = {
    # you could have as many databases as you want
    'default': {
...
ENVIRONMENT = Environment(value=os.environ["ENVIRONMENT"])
